...
<body style="font-weight:bolt;">
    <div id="app">
        ...
        <header class="mb-3">
            ...
            <div class="hedder" >
    <a href="../index.html"><h7 >DASHBOARD /</h7></a> <a href="pendignservice.php"><h7 style="color:Gray">PENDIGN SERVICE</h7></a>
...
echo"<td>"; ?> <div> <a href="ongoingjob.php?customerid=<?php echo $row["customerid"]; ?>"> <button type="button" id="button" name="submit" class="btn btn-success"style="background-color:#5cd65c">APPROVE</button> </a> <?php echo"</td>";

echo"</form>";


echo"<td>"; ?> <a href="reject.php?customerid=<?php echo $row["customerid"]; ?>"> <button type="button" id="button" name="close" class="btn btn-success"style="background-color:#FF5555">REJECT</button> </a> <?php echo"</td>";
