                    ...
                    <ul class="menu"> 
						...
						<li class="sidebar-item  has-sub">
                            ...
                            <li class="submenu-item ">
								...
								<li class="submenu-item ">
                                    <a href="sales_list.php">View All Sales</a>
                                </li>
...
<div class="newvehical">
    <div class="hedder" >
    <a href="../index.html" style="color:lightblue;"><h7>DASHBOARD /</h7></a> <a href=""><h7 style="color:gray;">All Sales</h7></a>
...
<div class="filters">
        <ul>
        <li><input class="search_input" type="text" name="search" placeholder="By CustomerID" id="myInput"  onkeyup="find1Function()"></li>
...
<table class="coll-log-12"  id="myTable">
  ...
  <tbody>
    ...
    <?php 
$res=mysqli_query($conn,"SELECT * FROM bill_prices"); //sending data for pending.php
...
echo"<td>"; echo $row["bill_code"]; echo"</td>";
echo"<td>"; echo $row["customerid"]; echo"</td>";
echo"<td>"; echo $row["pay_method"]; echo"</td>";
echo"<td>"; echo $row["service_charge"]; echo"</td>";
echo"<td>"; echo $row["sub_total"]; echo"</td>";
echo"<td>"; echo $row["bill_time"]; echo"</td>";
